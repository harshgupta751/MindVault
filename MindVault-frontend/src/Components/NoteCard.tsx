...
// import React, { useEffect, useState, useRef } from 'react';
// import type { SyntheticEvent } from 'react';
// import { Trash2, FileText, Video, Link, Hash, Image as ImageIcon, File } from 'lucide-react';
// import { FaStar, FaRegStar } from 'react-icons/fa';
// import Button from './Button';
...
//     {/* Show content link if available */}
//     {content && (
//       <a
//         href={content}
//         target="_blank"
...
//       <div className="px-4 pb-4 flex-grow flex flex-col">
//         {ogData.description && (
//          <h4 className="text-gray-600 text-[15px] italic font-medium mb-3 leading-snug tracking-tight">
//   {ogData.description}
// </h4>
...
//         {type === 'document' && renderDocumentLink()}
